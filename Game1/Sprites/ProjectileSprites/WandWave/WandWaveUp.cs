...
namespace Game1.ProjectileSprites
{
    class WandWaveUp : ISprite
    {
        ...
        public WandWaveUp(IProjectile projectile, Texture2D texture)
        {
        ...
        { 
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(texture, waveDestRec, waveSrcRec, Color.White, -(MathHelper.PiOver2), new Vector2(2,2),SpriteEffects.None,0); //gotta play around with origin vector due to rotation
            spriteBatch.End();
        }
    }
}
