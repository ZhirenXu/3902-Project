...
namespace Game1.ProjectileSprites
{
    class WandWaveDown : ISprite
    {
        ...
        public WandWaveDown(IProjectile projectile, Texture2D texture)
        {
        ...
        { 
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(texture, waveDestRec, waveSrcRec, Color.White, MathHelper.PiOver2, new Vector2(-10,17),SpriteEffects.None,0); //gotta play around with origin vector due to rotation
            spriteBatch.End();
        }
    }
}
