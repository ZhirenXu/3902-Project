...
namespace Game1.ProjectileSprites
{
    class WandWaveRight : ISprite
    {
        ...
        public WandWaveRight(IProjectile projectile, Texture2D texture)
        {
        ...
        { 
            ...
            Rectangle waveDestRec = new Rectangle((int)projectile.GetPosition().X+30, (int)projectile.GetPosition().Y, waveDestWidth, waveDestHeight);
            spriteBatch.Begin();
            spriteBatch.Draw(texture, waveDestRec, waveSrcRec, Color.White); 
            spriteBatch.End();
        }
    }
}
