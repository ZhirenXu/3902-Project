...
namespace Game1.ProjectileSprites
{
    class BoomerangLeft : ISprite
    {
        ...
        public BoomerangLeft(IProjectile projectile, Texture2D texture)
        {
        ...
        { 
            ...
            Rectangle boomDestRec = new Rectangle((int)projectile.GetPosition().X+10, (int)projectile.GetPosition().Y+25, boomDestWidth, boomDestHeight);
            spriteBatch.Begin();
